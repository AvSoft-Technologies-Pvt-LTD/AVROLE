...
const Counter = ({ end, duration = 2000, label, icon: Icon, delay = 0 }) => {
  ...
  return (
    ...
    bg-white/90 hover:shadow-[#F4C430]/20 hover:scale-105`}
    >
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] overflow-hidden relative py-12 px-4 md:px-8">
      ...
      <div className="absolute inset-0 rotate-bg">
        ...
        <div className="absolute -top-20 -left-20 w-96 h-96 bg-[#F4C430]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-32 -right-20 w-[30rem] h-[30rem] bg-[#F4C430]/10 rounded-full blur-3xl"></div>
      </div>
  ...
  <Sparkles className="text-[#F4C430] w-6 h-6 mr-3 animate-pulse" />
  <span className="text-[#0E1630] text-base lg:text-lg font-semibold tracking-wide">
    Your Health, Our Priority
              ...
              <div className="flex items-center text-lg backdrop-blur-sm px-4 py-2 ">
                <Activity className="text-[#F4C430] w-6 h-6 mr-2" />
                <span className="text-[#0E1630] font-medium">
                  {displayText}
                </span>
                <span className="animate-blink border-r-4 border-[#F4C430] h-6 ml-1"></span>
              </div>
