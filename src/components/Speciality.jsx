    ...
    <div className="w-full bg-[#f5f5f5] py-16">
      <section className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 relative">
          <span className="relative inline-block text-[#F4C430] text-xs font-semibold tracking-wider uppercase mb-3 py-1.5 px-3 rounded-full bg-[#F4C430]/10">
            Healthcare Excellence
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-[#0E1630] mb-4">
            Our Medical <span className="text-[#F4C430]">Specializations</span>
          </h2>
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="h-0.5 w-26 bg-[#F4C430] rounded-full"></div>
            <div className="h-0.5 w-46 bg-[#F4C430] rounded-full"></div>
            <div className="h-0.5 w-26 bg-[#F4C430] rounded-full"></div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
          {displayedSpecialties.map((specialty, index) => (
            ...
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-[#F4C430]/15 rounded-full -translate-x-12 -translate-y-12 group-hover:scale-150 transition-transform duration-500"></div>
              <div className="relative flex items-start gap-4">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-lg font-semibold text-[#0E1630] group-hover:text-[#F4C430] transition-colors duration-300">
                    {specialty.name}
                  </h3>
                  ...
                  <div className="flex items-center mt-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-1 group-hover:translate-y-0">
                    <Link
                      ...
                      className="flex items-center gap-1.5 text-[#F4C430] text-sm font-medium hover:gap-2 transition-all duration-300"
                    >
                      Learn More
              ...
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-[#F4C430] to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#F4C430] text-white px-8 py-3 rounded-full text-sm font-semibold shadow-lg hover:shadow-[#F4C430]/25 hover:bg-[#F4C430] transition-all duration-300 transform hover:scale-105 relative overflow-hidden group"
          >
