...
const IconWrapper = ({ children }) => (
  <div className="w-25 h-12 flex items-center justify-center rounded-md bg-[#F4C430]/10 text-[#0E1630]">
    {children}
  </div>
);

const IconWrapper1 = ({ children }) => (
  <div className="w-10 h-10 flex items-center justify-center rounded-full bg-[#F4C430]/10 text-[#0E1630]">
    {children}
  </div>
);
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-12 ms-8">
          ...
          <div className="w-full md:w-1/2 relative ms-10">
            <div className="absolute top-3 right-20 rounded-full w-40 h-40 bg-[#F4C430]/10"></div>
            <div
              className="absolute bottom-[-2px] left-[-40px] rotate-45 bg-[#F4C430]/10"
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mt-16 ms-10">
          <div className="w-full md:w-1/2 relative">
            <div className="absolute top-[-20px] left-[-30px] rounded-full w-40 h-40 bg-[#F4C430]/10"></div>
            <div className="absolute top-1/2 right-[-10px] rotate-45 rounded-full w-16 h-16 bg-[#F4C430]/10"></div>
            <div
              className="absolute bottom-[-2px] left-[-40px] rounded-lg"
              style={{
                backgroundColor: "#F4C4301A",
                width: "35px",
                height: "35px",
              }}
            ></div>
