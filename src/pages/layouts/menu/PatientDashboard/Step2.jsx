...
// // const Step2 = ({ selectedDoctor, selectedDate, selectedTime, setConsultationType, handleNext, handleBack }) => {
// //   return (
...
// //       <img
// //         src={selectedDoctor.photoUrl || "https://via.placeholder.com/100"} // fallback image
...
// //   <h3 className="font-medium font-semibold text-[#0e1630] mb-2"> Appointment Slot</h3>
...
// //   </p>
// //   <p className="text-gray-600">
// //     <span className="font-medium text-gray-800">ConsultationType:</span> {setConsultationType || "Not selected"}
// //   </p>
// // </div>

// //       {/* Confirm & Pay */}
// //       {/* <div className="bg-blue-50 p-5 rounded-lg border border-blue-300 text-sm text-[#0e1630]">
// //         <h3 className="text-base font-semibold mb-2">🧾 Confirm & Pay</h3>
// //         <p className="mb-2">
// //           Please review your selected doctor and appointment slot.
// //         </p>
// //         <p>
// //           Click "Next" to proceed with confirmation and payment.
// //         </p>
// //       </div> */}
