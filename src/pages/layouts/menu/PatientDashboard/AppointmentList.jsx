...
//     const apiUrl =
//       activeTab === 'doctor'
//         ? 'https://67e3e1e42ae442db76d2035d.mockapi.io/register/book' // Doctor appointments API
//         : 'https://your-lab-api-endpoint.com/appointments'; // Lab appointments API (replace with your actual URL)
...
//       });
//   }, [activeTab]); // Fetch appointments whenever the activeTab changes
...
//               className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${activeTab === 'doctor' ? 'bg-[#0e1630] text-white' : 'bg-gray-200 text-[#0e1630]'}`}
//             >
//                Doctor Appointments
//             </button>
//             <button
//               onClick={() => setActiveTab('lab')}
//               className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${activeTab === 'lab' ? 'bg-[#0e1630] text-white' : 'bg-gray-200 text-[#0e1630]'}`}
//             >
//                Lab Appointments
//             </button>
//           </div>
...
//           <button
//             onClick={() =>
//               navigate(activeTab === 'doctor' ? '/book-appointment' : '/book-lab')
//             }
...
//             />
//             <span className="absolute left-3.5 top-3 text-[#0e1630] text-lg">🔍</span>
//           </div>
//         </div>
//       </div>
...
//     <thead className="bg-[#0e1630] text-white text-xs uppercase font-semibold">
//       <tr>
//         {activeTab === 'doctor' && (
//           <>
...
//             {activeTab === 'doctor' && (
//               <>
//                 <td className="px-6 py-4 font-medium text-gray-800">{appointment.date || 'N/A'}</td>
//                 <td className="px-6 py-4 text-gray-600">{appointment.time || 'N/A'}</td>
//                 <td className="px-6 py-4 text-gray-700">{appointment.doctorName || 'N/A'}</td>
//                 <td className="px-6 py-4 text-gray-700">{appointment.specialty || 'N/A'}</td>
//               </>
//             )}
//             {activeTab === 'lab' && (
//               <>
//                 <td className="px-6 py-4 text-gray-700">{appointment.testName || 'N/A'}</td>
//                 <td className="px-6 py-4 text-gray-700">{appointment.labName || 'N/A'}</td>
//               </>
//             )}
//             <td className="px-6 py-4">
//               <span
//                 className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${appointment.status === 'Confirmed'
...
//       ) : (
//         <tr>
//           <td colSpan={activeTab === 'doctor' ? 5 : 3} className="text-center px-6 py-10 text-gray-400 text-base">
//             💤 No {activeTab === 'doctor' ? 'doctor' : 'lab'} appointments found.
//           </td>
//         </tr>
//       )}
//     </tbody>
  ...
  useEffect(() => {
    ...
    const apiUrl =
      activeTab === 'doctor'
        ...
        : 'https://your-lab-api-endpoint.com/appointments'; // Replace with real lab endpoint
